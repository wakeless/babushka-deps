...
dep "unicorn.upstart", :app_path do
  start_on "virtual-filesystems"
  stop_on "runlevel [06]"
  uid "nobody"
  gid "nobody"
  prestart "./bin/unicorn_rails -D -c #{app_path}/config/unicorn.rb --env production"
  poststop "kill `cat /opt/my_app/run/unicorn.pid`"
  service_name "unicorn_app"
